...
df = pd.read_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\combine80.csv')
...
# trian.to_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\combinetrain80pos.csv')  # 提取的特征写入excel中，提取的位置是什么
# test.to_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\combinetest80pos.csv')  # 提取的特征写入excel中，提取的位置是什么
...
np.save(r'C:\Users\69559\Desktop\80_shap_val.npy', shap_values, allow_pickle=True, fix_imports=True)
