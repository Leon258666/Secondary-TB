...
df = pd.read_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\Nomask56.csv')
...
#  'CC_deepfeature_500', 'CC_deepfeature_504' ,'CC_deepfeature_506']
...
# certain_feature_names = ['CC_deepfeature_3','CC_deepfeature_4','CC_deepfeature_5','CC_deepfeature_6']
...
trian = pd.read_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\deeptrain56pos.csv')
test = pd.read_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\deeptest56pos.csv')
# trian.to_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\deeptrain56pos.csv')  # 提取的特征写入excel中，提取的位置是什么
# test.to_csv(r'C:\Users\69559\Desktop\deepfeatureNonormalize\deeptest56pos.csv')  # 提取的特征写入excel中，提取的位置是什么
...
minor_list = [prediction[i] - test_Y[i] for i in range(0, len(prediction))]
...
# shap.summary_plot(shap_valfinal_df.values, X_input.values, feature_names=sorted_feature_names_list)
# # shap.summary_plot(shap_values[0], test_X, feature_names=certain_feature_names1[top_indices])
# # shap.summary_plot(shap_values, test_Xshap, plot_type="heatmap", feature_names=[f'Feature {i}' for i in range(certain_feature_names1[top_indices].shape[1])])
